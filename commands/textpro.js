...
//-----------------------------------------------------------------------------------
cmd({ pattern: "slice" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
cmd({ pattern: "glow" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
...
//----------------------------------------------------------------------------------- 
cmd({ pattern: "glitch1" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
...
//---------------------------------------------------------------------------
//================================================================================================
cmd({ pattern: "steal",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
...
//-----------------------------------------------------------------------------------
cmd({ pattern: "avenger",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            //if (!text) return citel.reply(`*_Example : ${prefix} text1;text2_*`); 
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
//-----------------------------------------------------------------------------------
cmd({ pattern: "marvel",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            ///if (!text) return citel.reply(`*_Example : ${prefix} text1;text2_*`); 
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
//-----------------------------------------------------------------------------------
cmd({ pattern: "phub",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
           // if (!text) return citel.reply(`*_Example : ${prefix} text1;text2_*`); 
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
cmd({ pattern: "glitch",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            //if (!text) return citel.reply(`*_Example : ${prefix} text1;text2_*`); 
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
//-----------------------------------------------------------------------------------
cmd({ pattern: "glitch2",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            //if (!text) return citel.reply(`*_Example : ${prefix} text1;text2_*`);
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
//-----------------------------------------------------------------------------------
cmd({ pattern: "grafiti",category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
            //if (!text) return citel.reply(`*_Example : ${prefix} text1;text2_*`);  
            let text1 = text ? text.split(';')[0] : '';
            let text2 = text ? text.split(';')[1] : '';
...
//---------------------------------------------------------------------------
    cmd({ pattern: "deepsea" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "horror" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "whitebear" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "joker" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "metallic" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "steel" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "harrypotter" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "underwater" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
         if (!text) return citel.reply(`*_Example : ${prefix} Void_*`);
        return await texttologo(Void, citel, '3d-underwater-text-effect-generator-online-1013' , text )
    })
    //---------------------------------------------------------------------------
cmd({ pattern: "luxury" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "glue" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "fabric" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "toxic" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "ancient" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "cloud" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "transformer" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "thunder" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "scifi" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({pattern: "sand" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "rainbow" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "pencil" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "neon" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({pattern: "magma" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "leaves" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "discovery" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "christmas" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "candy" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "1917" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
    ...
    //---------------------------------------------------------------------------
cmd({ pattern: "blackpink" , react: "👏" ,category: "logomaker", desc: "Some text to image feature with various styles.",filename: __filename, }, async(Void, citel, text) => {
